      ...
      <div className="relative min-h-screen flex flex-col items-center justify-center px-5 py-6">
        <div className="absolute top-5 right-5 z-20">
          <button
            ...
            className="px-3 py-2 rounded-lg bg-surface-card/60 backdrop-blur-sm border border-white/10 text-on-surface-muted hover:text-on-surface hover:border-white/20 transition-all duration-200 font-bold text-sm uppercase"
          >
            {language}
          </button>
        </div>
