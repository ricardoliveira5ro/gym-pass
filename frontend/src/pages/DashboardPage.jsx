        ...
        <div className="flex items-center justify-between mb-8">
          ...
          <div className="flex items-center gap-2">
            <button
              ...
              className="p-2.5 rounded-xl bg-surface-card/60 backdrop-blur-sm border border-white/[0.06] text-on-surface-muted hover:text-on-surface hover:border-white/10 transition-all duration-200"
            >
          ...
          <div className="animate-fade-up" style={{ animationDelay: '300ms', animationFillMode: 'forwards', opacity: 0 }}>
            <div className="relative group">
              ...
              >
                ...
                <p className="text-xs text-on-surface-muted mt-1">Find gyms</p>
              </button>
            </div>
          </div>
        </div>
