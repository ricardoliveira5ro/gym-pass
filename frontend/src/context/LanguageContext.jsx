...
const translations = {
  en: {
    ...
    qrCode: 'QR Code',
    qrCodeDesc: 'Show at gym entrance',
    insights: 'Insights',
    insightsDesc: 'View your statistics',
    membership: 'Membership',
    membershipActive: 'Active',
    membershipDaysLeft: 'days left',
    workoutsThisWeek: 'Workouts',
    workoutsThisWeekLabel: 'This week',
    totalCheckIns: 'Check-ins',
    totalCheckInsLabel: 'Total',
  ...
  pt: {
    ...
    qrCode: 'QR Code',
    qrCodeDesc: 'Mostrar na entrada',
    insights: 'Estatísticas',
    insightsDesc: 'Ver as tuas estatísticas',
    membership: 'Membro',
    membershipActive: 'Ativo',
    membershipDaysLeft: 'dias restantes',
    workoutsThisWeek: 'Treinos',
    workoutsThisWeekLabel: 'Esta semana',
    totalCheckIns: 'Check-ins',
    totalCheckInsLabel: 'Total',
    recentActivity: 'Atividade Recente',
    noActivity: 'Sem atividade recente',
    checkInAt: 'Check-in em',
    settings: 'Definições',
    logout: 'Sair',
