...
public class AuthController {
    ...
    public ResponseEntity<AuthResponse> register(@Valid @RequestBody RegisterRequest request, HttpServletResponse response) {
        ...
        return ResponseEntity.ok(new AuthResponse("Registration successful", result.email(), result.role()));
    }
    ...
    public ResponseEntity<AuthResponse> login(@Valid @RequestBody LoginRequest request, HttpServletResponse response) {
        ...
        setJwtCookies(result.token(), response);
        return ResponseEntity.ok(new AuthResponse("Login successful", result.email(), result.role()));
    }
